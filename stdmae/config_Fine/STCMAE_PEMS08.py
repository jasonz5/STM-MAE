...
from .stdmae_arch import STCMAE
from .stdmae_runner import STCMAERunner
...
# ================= general ================= #
CFG.DESCRIPTION = "STCMAE(PEMS08) configuration"
CFG.RUNNER = STCMAERunner
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STCMAE"
CFG.MODEL.ARCH = STCMAE
adj_mx, _ = load_adj("datasets/" + CFG.DATASET_NAME + "/adj_mx.pkl", "doubletransition")
CFG.MODEL.PARAM = {
    "dataset_name": CFG.DATASET_NAME,
    "pre_trained_stmae_path": "mask_save/STMAE_PEMS08_864.pt",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
