...
from .stdmae_arch import STDMAESIMPLE
...
# ================= general ================= #
CFG.DESCRIPTION = "SD to PEMS04 Simple configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STDMAE_SIMPLE"
CFG.MODEL.ARCH = STDMAESIMPLE
...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_smae_path": "mask_save/SMAE_SD_864.pt",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
